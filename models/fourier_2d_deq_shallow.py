...
class BasicBlock(nn.Module):
    ...
    def __init__(self, modes1, modes2, width, add_mlp=False):
...
class FNO2dDEQShallow(nn.Module):
    def __init__(self, modes1, modes2, width, 
        ...
        super(FNO2dDEQShallow, self).__init__()
        ...
        self.fc = nn.Linear(3, self.width) # input channel is 3: (a(x, y), x, y)
        ...
        self.deq_block = StackedBasicBlock(
            self.modes1, 
            self.modes2, 
            self.width, 
            depth=block_depth, 
